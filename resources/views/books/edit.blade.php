...
<div class="container">
    <div class="row">
        <div class="col col-8">
            ...
            <form class="my-4" action="{{ route('books.update', $book) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="series" type="text" class="form-control" id="series" value="{{ $book->series }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="type" type="text" class="form-control" id="type" value="{{ $book->type }}">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Link img</label>
                    <input name="thumb" type="text" class="form-control" id="thumb" value="{{ $book->thumb }}">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Prezzo</label>
                    <input name="price" type="price" class="form-control" id="price" value="{{ $book->title }}">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Data di uscita</label>
                    <input name="sale_date" type="date" class="form-control" id="sale_date" value="{{ $book->sale_date }}">
                </div>
